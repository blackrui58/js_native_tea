...
mysql_query('CREATE database aaa_wish');
mysql_select_db('aaa_wish');
...
switch($act){
	case 'add':
		...
		$i_sql="INSERT INTO  `aaa_wish`.`wish` (`ID` ,`username` ,`content`,`time`) VALUES (NULL ,  '".$username."',  '".$content."',".time().")";
		mysql_query($i_sql);
